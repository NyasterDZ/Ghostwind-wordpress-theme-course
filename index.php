				...
				<nav class="mt-0 w-full">
					<div class="container mx-auto flex items-center">
							 ...
							 <ul class="list-reset flex justify-between flex-1 md:flex-none items-center">
								...
								<a class="inline-block text-gray-600 no-underline hover:text-gray-200 hover:underline py-2 px-2" href="post_vue.html">POST_VUE</a>
									<ul class="p-6 mega-menu mb-16 sm:mb-0 shadow-xl bg-blue-800">
										<li class="px-4 w-full sm:w-1/2 lg:w-1/4 border-gray-600 border-b sm:border-r lg:border-b-0 pb-6 pt-6 lg:pt-3">
										...
										<li class="px-4 w-full sm:w-1/2 lg:w-1/4 border-gray-600 border-b sm:border-r-0 lg:border-r lg:border-b-0 pb-6 pt-6 lg:pt-3">
											<div class="flex items-center">
												<svg class="h-8 mb-3 mr-3 fill-current text-white"
												xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
										...
										<li class="px-4 w-full sm:w-1/2 lg:w-1/4 border-gray-600 border-b sm:border-b-0 sm:border-r md:border-b-0 pb-6 pt-6 lg:pt-3">
											<div class="flex items-center">
												<svg class="h-8 mb-3 mr-3 fill-current text-white"
												xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
						...
						<div class="flex w-1/2 justify-end content-center">		
							...
							<?php
									if(get_theme_mod('gw_social_media_twitter_setting')){ ?>
										<a class="inline-block text-gray-500 no-underline hover:text-white hover:text-underline text-center h-10 p-2 md:h-auto md:p-4 avatar" data-tippy-content="@twitter_handle" href="<?php echo get_theme_mod('gw_social_media_twitter_setting') ?>">
								...
								<?php } ?>
							<?php
									if(get_theme_mod('gw_social_media_facebook_setting')){ ?>
										<a class="inline-block text-gray-500 no-underline hover:text-white hover:text-underline text-center h-10 p-2 md:h-auto md:p-4 avatar" data-tippy-content="<?php echo get_theme_mod('gw_social_media_facebook_tooltip_setting') ?>" href="<?php echo get_theme_mod('gw_social_media_facebook_setting')?>">
							...
							<a href="<?php the_permalink()?>" class="flex flex-wrap no-underline hover:no-underline">
								...
								<div class="w-full md:w-1/3 flex flex-col flex-grow flex-shrink">
									<div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow-lg">
										...
										<div class="w-full font-bold text-xl text-gray-900 px-6">👋<?php echo get_the_title();?></div>
									...
									<div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow-lg p-6">
										<div class="flex items-center justify-between">
											...
											<p class="text-gray-600 text-xs md:text-sm"><?php the_date()?></p>
										</div>
									</div>
								</div>
							</a>
					...
					<!-- <div class="w-full md:w-1/2 p-6 flex flex-col flex-grow flex-shrink">
						<div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow-lg">
							<a href="#" class="flex flex-wrap no-underline hover:no-underline">
								<img src="" class="h-full w-full rounded-t pb-6">
